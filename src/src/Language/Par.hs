...
{-# INLINE happyOut11 #-}
newtype HappyWrap12 = HappyWrap12 (Language.Abs.PIdent)
happyIn12 :: (Language.Abs.PIdent) -> (HappyAbsSyn )
happyIn12 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap12 x)
{-# INLINE happyIn12 #-}
happyOut12 :: (HappyAbsSyn ) -> HappyWrap12
happyOut12 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut12 #-}
newtype HappyWrap13 = HappyWrap13 (Language.Abs.Program)
happyIn13 :: (Language.Abs.Program) -> (HappyAbsSyn )
happyIn13 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap13 x)
{-# INLINE happyIn13 #-}
happyOut13 :: (HappyAbsSyn ) -> HappyWrap13
happyOut13 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut13 #-}
newtype HappyWrap14 = HappyWrap14 (Language.Abs.Stmt)
happyIn14 :: (Language.Abs.Stmt) -> (HappyAbsSyn )
happyIn14 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap14 x)
{-# INLINE happyIn14 #-}
happyOut14 :: (HappyAbsSyn ) -> HappyWrap14
happyOut14 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut14 #-}
newtype HappyWrap15 = HappyWrap15 ([Language.Abs.Stmt])
happyIn15 :: ([Language.Abs.Stmt]) -> (HappyAbsSyn )
happyIn15 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap15 x)
{-# INLINE happyIn15 #-}
happyOut15 :: (HappyAbsSyn ) -> HappyWrap15
happyOut15 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut15 #-}
newtype HappyWrap16 = HappyWrap16 (Language.Abs.Exp)
happyIn16 :: (Language.Abs.Exp) -> (HappyAbsSyn )
happyIn16 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap16 x)
{-# INLINE happyIn16 #-}
happyOut16 :: (HappyAbsSyn ) -> HappyWrap16
happyOut16 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut16 #-}
newtype HappyWrap17 = HappyWrap17 (Language.Abs.Exp)
happyIn17 :: (Language.Abs.Exp) -> (HappyAbsSyn )
happyIn17 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap17 x)
{-# INLINE happyIn17 #-}
happyOut17 :: (HappyAbsSyn ) -> HappyWrap17
happyOut17 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut17 #-}
newtype HappyWrap18 = HappyWrap18 (Language.Abs.Exp)
happyIn18 :: (Language.Abs.Exp) -> (HappyAbsSyn )
happyIn18 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap18 x)
{-# INLINE happyIn18 #-}
happyOut18 :: (HappyAbsSyn ) -> HappyWrap18
happyOut18 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut18 #-}
newtype HappyWrap19 = HappyWrap19 (Language.Abs.Exp)
happyIn19 :: (Language.Abs.Exp) -> (HappyAbsSyn )
happyIn19 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap19 x)
{-# INLINE happyIn19 #-}
happyOut19 :: (HappyAbsSyn ) -> HappyWrap19
happyOut19 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut19 #-}
newtype HappyWrap20 = HappyWrap20 (Language.Abs.Exp)
happyIn20 :: (Language.Abs.Exp) -> (HappyAbsSyn )
...
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_pProgram","%start_pStmt","%start_pListStmt","%start_pExp1","%start_pExp2","%start_pExp3","%start_pExp4","%start_pExp","Integer","PIdent","Program","Stmt","ListStmt","Exp1","Exp2","Exp3","Exp4","Exp","'('","')'","'*'","'+'","'-'","'/'","';'","'='","L_integ","L_PIdent","%eof"]
...
happyReduction_9 happy_x_1
	...
	happyIn12
		 (Language.Abs.PIdent (mkPosToken happy_var_1)
	)}
...
happyReduction_11 happy_x_3
	...
	happyIn14
		 (Language.Abs.SAss happy_var_1 happy_var_3
	)}}
...
happyReduction_16 happy_x_3
	...
	happyIn16
		 (Language.Abs.ExpAdd happy_var_1 happy_var_3
	)}}
...
happyReduction_18 happy_x_3
	...
	happyIn17
		 (Language.Abs.ExpSub happy_var_1 happy_var_3
	)}}
...
happyReduction_20 happy_x_3
	...
	happyIn18
		 (Language.Abs.ExpMul happy_var_1 happy_var_3
	)}}
...
happyReduction_21 happy_x_3
	...
	case happyOut19 happy_x_3 of { (HappyWrap19 happy_var_3) -> 
	happyIn18
		 (Language.Abs.ExpDiv happy_var_1 happy_var_3
	)}}
...
happyReduction_23 happy_x_1
	...
	happyIn19
		 (Language.Abs.ExpLit happy_var_1
	)}
...
happyReduction_24 happy_x_1
	 =  case happyOut12 happy_x_1 of { (HappyWrap12 happy_var_1) -> 
	happyIn19
		 (Language.Abs.ExpVar happy_var_1
	)}
